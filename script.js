function start() {
    ...
    function disparo() {
        ...
        if (podeAtirar == true) {
            ...
            var tempoDisparo = window.setInterval(executeDisparo, 30)
        }
    ...
    function gameOver() {
        ...
        $("#fim").html("<h1> Game Over </h1> <p>Sua pontuação foi: " +pontos+ "</p>" + "<div id='renecia' onClick='reniciaJogo()'><h3>Jogar Novamente</h3></div>")
    }
}
